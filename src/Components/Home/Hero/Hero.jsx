...
const slides = [
  {
    ...
    subtitle: "Access top hospitals, quality health plans & 24/7 support for every Lagos resident.",
  ...
  },
  {
    ...
    subtitle: "Access top hospitals & clinics with monthly payment plans and reliable support.",
