  ...
  return (
    <>
      ...
      <header className={`fixed w-full z-10 bg-slate-100 transition-transform duration-300 ease-in-out ${showHeader ? 'translate-y-[72px]' : '-translate-y-full'}`}>
        <nav className='flex flex-col items-center bg-slate-100'>

          {/* Marquee Section */}
          <div className="marquee-container bg-black text-white py-2">
            <div className="marquee-content">
              For assistance, contact our 24/7 support lines: 
              <span className="contact-numbers">
                0800-453-72356, 0800-275-527462, 0700-453-72356, 0916-918-5920, 0704-027-7029.
              </span> 
              WhatsApp Support: 
              <span className="contact-numbers">
                0704-535-8275, 0704-616-0051.
              </span>
            </div>
          </div>
              ...
              <ul className='flex md:flex-row flex-col items-center md:items-start md:gap-[4vw] gap-8'>
                ...
                >
                  ...
                  <ul className={`absolute left-0 ${dropdownOpen ? 'block' : 'hidden'} group-hover:block flex-col bg-white shadow-lg rounded-md mt-2 w-56 space-y-4 transition-opacity duration-300 ease-in-out`}>
                    ...
                    <li><Link to='https://bit.ly/change-my-ileraeko-provider' className='hover:bg-[#f1f1f1] py-2 px-4 rounded-md'>Change Hospital</Link></li>
                  </ul>
                </li>
