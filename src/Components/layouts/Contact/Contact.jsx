...
const data = [
  ...
  },
  {
    ...
    contact_head_text_icon: <i class="fa-solid fa-phone"></i>,
  ...
  },
  {
    ...
    contact_head_text_icon: <i class="fa-brands fa-whatsapp"></i>,
    contact_head_body: '(234) 0800-4537-2356',
  ...
  },
  {
    ...
    contact_head_text_icon: <i class="fa-solid fa-envelope-open-text"></i>,
