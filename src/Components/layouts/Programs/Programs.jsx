...
const data = [
  {
    ...
    more: <button><Link to='https://ileraeko.com'>more</Link><i className='fa fa-long-arrow-alt-right'></i></button>
  },
  {
    id:2,
    image: lshs,
    ...
    more: <button><Link to='https://lshsregulation.com'>more</Link> <i className='fa fa-long-arrow-alt-right'></i></button>
  },
  {
    id:3,
    image: ekotelemed,
    ...
    more: <button><Link to='#'>more </Link><i className='fa fa-long-arrow-alt-right'></i></button>
  },
  {
    id:4,
    image: ekosha,
    ...
    more: <button><Link to='https://ekosha.org'>more </Link><i className='fa fa-long-arrow-alt-right'></i></button>
  }
]
